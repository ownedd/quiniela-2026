...
export const teams = [
  ...
  // Grupo I
  { name: "Argentina", code: "ARG", group: "I", flagUrl: `${FLAG_BASE}/ar.svg` },
  { name: "Colombia", code: "COL", group: "I", flagUrl: `${FLAG_BASE}/co.svg` },
  { name: "Senegal", code: "SEN", group: "I", flagUrl: `${FLAG_BASE}/sn.svg` },
  { name: "Por definir I4", code: "TBD", group: "I" },

  // Grupo J
  { name: "Francia", code: "FRA", group: "J", flagUrl: `${FLAG_BASE}/fr.svg` },
  { name: "Camerún", code: "CMR", group: "J", flagUrl: `${FLAG_BASE}/cm.svg` },
  { name: "Por definir J3", code: "TBD", group: "J" },
  { name: "Por definir J4", code: "TBD", group: "J" },

  // Grupo K
  { name: "Inglaterra", code: "ENG", group: "K", flagUrl: `${FLAG_BASE}/gb-eng.svg` },
  { name: "Nigeria", code: "NGA", group: "K", flagUrl: `${FLAG_BASE}/ng.svg` },
  { name: "Por definir K3", code: "TBD", group: "K" },
  { name: "Por definir K4", code: "TBD", group: "K" },

  // Grupo L
  { name: "Portugal", code: "POR", group: "L", flagUrl: `${FLAG_BASE}/pt.svg` },
