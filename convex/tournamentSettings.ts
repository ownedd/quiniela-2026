  ...
  handler: async (ctx) => {
    ...
    return (
      settings ?? {
        ...
        lockedAt: undefined,
        updatedBy: undefined,
        actualTopScorer: undefined,
        actualMostGoalsTeam: undefined,
        actualLeastConcededTeam: undefined,
    ...
    if (locked) {
      ...
      if (existing) {
        await ctx.db.patch(existing._id, {
          ...
          lockedAt: now,
          updatedBy: user._id,
          actualTopScorer: existing.actualTopScorer,
          actualMostGoalsTeam: existing.actualMostGoalsTeam,
          actualLeastConcededTeam: existing.actualLeastConcededTeam,
          predictionsExportStorageId: undefined,
