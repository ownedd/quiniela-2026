      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="glass-card p-6 border-l-4 border-l-blue-500 hover:scale-[1.02] transition-transform cursor-default">
          ...
          <ul className="text-sm text-gray-400 space-y-2">
            <li>
              • Resultado exacto: <span className="text-white font-bold">3 puntos</span>
            </li>
            <li>
              • Acertar ganador o empate: <span className="text-white font-bold">1 punto</span>
            </li>
          </ul>
        </div>
        <div className="glass-card p-6 border-l-4 border-l-purple-500 hover:scale-[1.02] transition-transform cursor-default">
          ...
          <p className="text-sm text-gray-400">
            Ve a la sección de{" "}
            <a href="/predictions" className="text-purple-400 hover:underline">
              Mis Predicciones
            </a>{" "}
            para completar tu quiniela antes del pitazo inicial.
          </p>
        </div>
      </div>
    </div>
